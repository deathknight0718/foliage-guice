...
import static page.foliage.inject.internal.Element.Type.MULTIBINDER;
...
import static page.foliage.inject.name.Names.named;
...
import page.foliage.inject.multibindings.MultibinderBinding;
...
public final class RealMultibinder<T> implements Module {
  ...
  boolean containsElement(page.foliage.inject.spi.Element element) {
  ...
  private static final class ExtensionRealMultibinderProvider<T> extends BaseFactory<T, Set<T>>
    ...
    @Override
    public boolean containsElement(page.foliage.inject.spi.Element element) {
      return bindingSelection.containsElement(element);
    }
  }
