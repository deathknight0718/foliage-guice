 ...
 * {@link page.foliage.inject.Binder} {@code bindXXX()} methods and eventually
 ...
 * <p>
 * The sequence of class names of {@link page.foliage.inject.Module modules}
...
public final class ElementSource {
  ...
  /**
   * Returns the position of {@link page.foliage.inject.Module#configure configure(Binder)} method
  ...
  /**
   * Returns the sequence of method calls that ends at one of {@link page.foliage.inject.Binder}
