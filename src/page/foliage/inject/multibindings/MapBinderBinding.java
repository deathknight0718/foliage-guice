...
public interface MapBinderBinding<T> {
   ...
   * {@code Map<K, page.foliage.inject.Provider<V>>}, {@code Map<K, javax.inject.Provider<V>>}, {@code
   * Map<K, Set<page.foliage.inject.Provider<V>>>}, {@code Map<K, Set<javax.inject.Provider<V>>>},
   * {@code Map<K, Collection<page.foliage.inject.Provider<V>>>}, {@code Map<K,
