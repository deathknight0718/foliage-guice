 ...
 * {@link page.foliage.inject.PrivateModule PrivateModule} for details.
 * 
...
public interface PrivateBinder extends Binder {
   ...
   * page.foliage.inject.binder.AnnotatedElementBuilder#annotatedWith(Class) annotatedWith()} to expose {@code type} with a
   * binding annotation.
   */
