 ...
 * page.foliage.inject.Provides Provides} bindings can be exposed with the {@literal @}{@link Exposed}
 * annotation:
 *
 * <pre>
...
public abstract class PrivateModule implements Module {
   ...
   *     page.foliage.inject.matcher.Matcher, org.aopalliance.intercept.MethodInterceptor[])
   */
  ...
  /**
   * @see Binder#convertToTypes(page.foliage.inject.matcher.Matcher,
   *     page.foliage.inject.spi.TypeConverter)
   */
